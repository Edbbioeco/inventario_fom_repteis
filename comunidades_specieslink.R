...
specieslink_sf_fom <- specieslink_sf_fom |>
  dplyr::mutate(
    ...
    scientificname = dplyr::case_match(
      ...
      c("Clelia clelia", "Clelia rustica") ~ "Paraphimophis rusticus",
    ...
    scientificname = scientificname |> stringr::str_replace("Sibynomorphus", "Dipsas")
  ) |>
  dplyr::mutate(
    scientificname = dplyr::case_match(
      scientificname,
    ...
    family = dplyr::case_when(
      scientificname |> stringr::str_detect("Urostrophus") ~ "Iguanidae",
      scientificname |> stringr::str_detect("Enyalius") ~ "Leiosauridae",
      scientificname |> stringr::str_detect("Liotyphlops") ~ "Anomalepididae",
      scientificname |> stringr::str_detect("Notomabuya") ~ "Scincidae",
      scientificname |> stringr::str_detect("Ophiodes") ~ "Diploglossidae",
      scientificname |> stringr::str_detect("Palusophis") ~ "Colubridae",
      scientificname |> stringr::str_detect("Podocnemis") ~ "Podocnemididae",
      scientificname |> stringr::str_detect("Apostolepis|Atractus|Boiruna|Clelia|Dibernardia|Dipsas|Dryophylax|Echinanthera|Erythrolamprus|Gomesophis|Oxyrhopus|Helicops|Imantodes|Mesotes|Paraphimophis|Phalotris|Philodryas|Pseudoboa|Ptychophis|Rhachidelus|Siphlophis|Taeniophallus|Thamnodynastes|Tomodon|Tropidodryas|Cercophis|Xenodon|Lygophis|Adelphostigma|Pseudablabes") ~ "Dipsadidae",
