...
sibbr_sf_fom <- sibbr_sf_fom |>
  dplyr::mutate(
    species = species |> stringr::str_squish(),
    species = dplyr::case_match(
      ...
      "Clelia rustica" ~ "Paraphimophis rusticus",
    ...
    species = species |> stringr::str_replace("Sibynomorphus", "Dipsas")
  ) |>
  dplyr::mutate(
    species = dplyr::case_match(
      species,
